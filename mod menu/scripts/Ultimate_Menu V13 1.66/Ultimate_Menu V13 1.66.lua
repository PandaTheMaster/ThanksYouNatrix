...
L7NEG = menu.add_submenu("Ultimate Menu 1.66 By L7NEG")
...
Text("==============================================================")
Text("                      Written By L7NEG")
Text("       ✅ Ultimate Menu 1.66 [V13] ✅ ")
Text("                   https://l7neg.tk               ")
Text("==============================================================")
...
Self:add_int_range("Set Level (Correction)", 1, 0, 8000, function()
...
Self:add_action("Remove Transaction Error", function() if globals.get_int(4536679) == 20 or globals.get_int(4536679) == 4 then globals.set_int(4536673, 0) end end)
...
RONECLICKMenu:add_action("Ace Mask Casino Store", function()
		globals.set_int(289323, 1)
		globals.set_int(289324, 1)
		globals.set_int(289325, 1)
		globals.set_int(289326, 1)
end)
RONECLICKMenu:add_action("Up-n-Atomizer", function()
		globals.set_int(102764, 90)
end)
RONECLICKMenu:add_action("Festive tint", function()
		globals.set_int(102765, 1)
end)
Text("==========================")
RONECLICKMenu:add_action("Valentine Unlocks", function()
...
---global found by dr-NHA On Github Updated By L7NEG#0743
---https://l7neg.tk
---https://dsc.gg/l7neg-
...
VehiclesM:add_array_item("Request Services", {"M.O.C", "Avenger", "TerrorByte", "Kosatka", "Dinghy", "Ammo Drop"}, function() return xox_01 end, function(v) if v == 1 then globals.set_int(REQS1+ 925, 1) elseif v == 2 then globals.set_int(REQS1+ 933, 1) elseif v == 3 then globals.set_int(REQS1+ 937, 1) elseif v == 4 then globals.set_int(REQS1+ 954, 1) elseif v == 5 then globals.set_int(REQS1+ 966, 1) else globals.set_int(REQS1+ 886, 1) end xox_01 = v end)
...
L7NEGCASINO:add_int_range("Casino Lifes - Self", 1, 1, 999999999, function() return fmC:get_int(26133 + 1325 + 1) end, function(life) if fmC and fmC:is_active() then fmC:set_int(26133 + 1325 + 1,life) end end)
...
L7NEG3:add_action("Unlock GunVan RailGun", function()
...
L7NEGNCNOTE:add_action("https://dsc.gg/l7neg-", function() end)
...
L7NEGHANGNOTE:add_action("https://dsc.gg/l7neg-", function() end)
...
L7NEGARCNOTE:add_action("https://dsc.gg/l7neg-", function() end)
...
L7NEGMW29 = L7NEGEVENTS:add_submenu("MW29 Event Menu")

---------------------------------------------------------------------------------------------------------------------------------

L7NEGMW29:add_action("Enable Weazel Bank Shootout Event", function()
...
L7NEGMW29:add_toggle("Is The Event Enabled", function()
...
L7NEGMW29:add_action("Teleport NO1", function()
	 teleport_myself(-926.20, -501.58, 35.79)
 end)

L7NEGMW29:add_action("Teleport NO2", function()
	 teleport_myself(-894.06, -448.18, 174.15)
 end)

----------------------------------------------------------------------------------------------------------------------------------

L7NEGMW29README = L7NEGMW29:add_submenu("Read Me")

L7NEGMW29README:add_action("==============================", function() end)

L7NEGMW29README:add_action("     Instructions", function() end)

L7NEGMW29README:add_action("==============================", function() end)

L7NEGMW29README:add_action("First Go Public Session", function() end)

L7NEGMW29README:add_action("Then Teleport  To  Place NO1", function() end)

L7NEGMW29README:add_action("Then Active Enable Weazel Bank", function() end)

L7NEGMW29README:add_action("Shootout Event", function() end)

L7NEGMW29README:add_action("Then Stand AFK And Waiting For 20m", function() end)

L7NEGMW29README:add_action("After That, From 20:00 To 06:00, Wait", function() end)
 
L7NEGMW29README:add_action("For", function() end)

L7NEGMW29README:add_action("The Appearance Of a Red Marker", function() end)

L7NEGMW29README:add_action("Use The Teleport NO2 To Get On Top Of", function() end)

L7NEGMW29README:add_action("The Building To Get The MW29", function() end)

L7NEGMW29README:add_action("If It Does Not Appear", function() end)

L7NEGMW29README:add_action("Then Change The Session", function() end)


----------------------------------------------------------------------------------------------------------------------------------

L7NEGGOOCH = L7NEGEVENTS:add_submenu("Gooch Spawn Menu")

----------------------------------------------------------------------------------------------------------------------------------

L7NEGGOOCH:add_action("Spawn Gooch", function()
...
L7NEG1:add_action("L7NEG For Building And Updating This", function() end)

L7NEG1:add_action("          OP Project", function() end)
...
L7NEG1:add_action("MxGta#1746", function() end)

L7NEG1:add_action("NON5TOP#0001", function() end)

L7NEG1:add_action("& Glazgo#0001 On", function() end)

L7NEG1:add_action("Discord And", function() end)

L7NEG1:add_action("Special Thanks To You All For", function() end)

L7NEG1:add_action("         The Ideas", function() end)

L7NEG1:add_action("L7NEG For The Ultimate Money", function() end)

L7NEG1:add_action("          Codes", function() end)

L7NEG1:add_action("This Is Sam On Youtube", function() end)
...
L7NEG1:add_action("And Have A Nice Day <3", function() end)
